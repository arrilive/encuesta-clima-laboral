...
// Flujo OTP v1.1
Route::post('/encuesta/verificar-llave', [EncuestaController::class, 'verificarLlave'])
    ->name('encuesta.verificar-llave')->middleware('throttle:10,1');
Route::post('/encuesta/solicitar-otp', [EncuestaController::class, 'solicitarOtp'])
    ->name('encuesta.solicitar-otp')->middleware('throttle:5,1');
Route::post('/encuesta/verificar-otp', [EncuestaController::class, 'verificarOtp'])
    ->name('encuesta.verificar-otp')->middleware('throttle:10,1');
